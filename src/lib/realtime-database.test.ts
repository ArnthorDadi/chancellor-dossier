...
describe('Realtime Database', () => {
  ...
  describe('dbPaths', () => {
    it('should generate correct paths', () => {
      ...
      expect(dbPaths.roomInvestigations('TEST1')).toBe('rooms/TEST1/investigations')
      expect(dbPaths.player('TEST1', 'user123')).toBe('rooms/TEST1/players/user123')
      expect(dbPaths.role('TEST1', 'user123')).toBe('rooms/TEST1/roles/user123')
      expect(dbPaths.investigation('TEST1', 'user123')).toBe('rooms/TEST1/investigations/user123')
    })
  })
  ...
  describe('room operations', () => {
    ...
    it('should remove player from room', async () => {
      ...
      expect(remove).toHaveBeenCalledWith({ ref: 'rooms/TEST1/players/user123' })
    })
