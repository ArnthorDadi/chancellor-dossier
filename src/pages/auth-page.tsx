      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        {user && isCreatingRoom ? (
          <div className="bg-white border-2 border-noir-black rounded-lg p-8 text-center">
            ...
            <h2 className="font-special-elite text-xl text-liberal-blue mb-2">ESTABLISHING SAFE HOUSE...</h2>
            <p className="font-courier text-sm text-noir-black/70">Initializing secure location</p>
          </div>
        ) : (
          <AuthForm />
        )}
