    ...
    <div className="min-h-screen bg-parchment-bg text-noir-black">
      ...
      <div className="relative z-10">
        ...
        <header
          ...
          style={{
            background: 'linear-gradient(to right, var(--liberal-blue), var(--fascist-red))'
          }}
        >
          ...
          <div className="absolute inset-0 opacity-20">
            <div className="absolute inset-0"
                 style={{
                   background: 'linear-gradient(to top right, rgba(255,255,255,0.1), transparent, rgba(0,0,0,0.1))'
                 }}>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 py-8 text-center relative z-10">
              <div
                className="border-4 border-noir-black p-6 shadow-2xl transform rotate-1 bg-vintage-cream"
              >
                <h1
        ...
        <section className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            <div className="relative inline-block max-w-full w-full sm:max-w-md lg:max-w-lg">
              {/* Tape effects */}
              <div
                  className="absolute z-10 top-0 left-1/2 transform -translate-x-1/2 -translate-y-2 w-24 h-4 bg-yellow-400/80 border border-noir-black shadow-md"></div>
